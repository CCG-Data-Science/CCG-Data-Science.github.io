...
The intention is to equip learners with the skills to work in data science/data analytics. On completion of the course learners could either seek employment or, possibly, complete their honours degree in the BSc Data Analytics and Modelling.
...
* issing values, scaling, normalisation
* JSON, XML etc
...
* Bias/ Variance trade off; LDimension Reduction
